...
const controller = require('../controllers/about');//En este momento esta dentro de views/auth, por lo que se necesita salir y entrar a la carpeta correspondiente
